        ...
        >
          ...
          >
            ...
            <div className="text-gray-300 text-sm sm:text-base leading-relaxed mb-5 text-center lg:text-left space-y-3 font-light">
              ...
              <p className="text-gray-400 text-xs sm:text-sm">
                I leverage Antigravity to write frontends and ship full-stack applications end-to-end.
              </p>
            </div>
            ...
            <div className="mt-1 flex items-center justify-center lg:justify-start gap-2.5 sm:gap-3 flex-wrap w-full">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2 sm:p-2.5 rounded-xl border border-white/10 text-gray-400 hover:text-white hover:border-white/25 hover:bg-white/[0.04] transition-all duration-200"
