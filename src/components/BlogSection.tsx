...
const BlogSection = () => {
  ...
  return (
    <section
      className="w-full max-w-6xl mx-auto py-20 sm:py-24 md:py-28 px-4 sm:px-6 md:px-8 relative rounded-3xl bg-gradient-to-br from-gray-800/40 to-gray-900/40 border border-gray-700/50 shadow-2xl"
