...
const SocialLink = memo(({ 
  ...
  >
    ...
    {/* Icon with enhanced styling - compact for mobile */}
    <div 
      className={`relative z-10 p-2.5 transition-all duration-300 ${
...
const socialLinks = [
  {
    ...
    icon: (isHovered: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 sm:w-7 sm:h-7" fill={isHovered ? "#0A66C2" : "currentColor"}>
  ...
  },
  {
    ...
    icon: (isHovered: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 sm:w-7 sm:h-7" fill={isHovered ? "#10B981" : "currentColor"}>
  ...
  },
  {
    ...
    icon: (isHovered: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 sm:w-7 sm:h-7" fill={isHovered ? "#8B5CF6" : "currentColor"}>
  ...
  },
  {
    ...
    icon: (isHovered: boolean) => (
      <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-7 sm:h-7" fill={isHovered ? "#FFA116" : "currentColor"}>
    ...
    <div className="w-full relative overflow-visible about-section section-mobile-padding">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 sm:py-28 md:py-36 pt-24 sm:pt-28 md:pt-36 pb-24 sm:pb-28 md:pb-36">
        <motion.div 
          ...
          initial="hidden" 
          animate={controls} 
          className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-20 items-center"
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-center lg:items-start">
            <div className="relative group">
              ...
              <div className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full overflow-hidden border border-white/30 backdrop-blur-2xl z-20 transform group-hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                <div 
          ...
          <motion.div variants={itemVariants} className="flex flex-col">
            ...
            <div className="mb-8">
              ...
              >
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-heading font-bold mb-3 heading-gradient-cool-left-emphasis text-center md:text-left">
                  Shreyan Sardar
                </h1>
