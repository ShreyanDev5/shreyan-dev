...
const socialLinks = [
  {
    ...
    icon: (isHovered: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6" fill={isHovered ? "#0A66C2" : "currentColor"}>
  ...
  },
  {
    ...
    icon: (isHovered: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6" fill={isHovered ? "#10B981" : "currentColor"}>
  ...
  },
  {
    ...
    icon: (isHovered: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6" fill={isHovered ? "#8B5CF6" : "currentColor"}>
  ...
  },
  {
    ...
    icon: (isHovered: boolean) => (
      <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6" fill={isHovered ? "#FFA116" : "currentColor"}>
