    ...
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 pt-16 pb-12 sm:pt-0 sm:pb-0 text-center">
        ...
        >
          ...
          >
            CS graduate focused on backend development, APIs, databases, and clean system design. Uses AI tools to speed up workflows and handle frontend work when needed.
          </motion.p>
