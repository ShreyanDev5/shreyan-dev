      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-heading font-bold mb-4 sm:mb-6 tracking-tight heading-gradient-brand">
              Tech Stack
            </h2>
          </motion.div>
          
          <div className="w-24 sm:w-32 h-[3px] bg-gradient-to-r from-emerald-500 to-cyan-500 mx-auto mb-4 sm:mb-6 rounded-full" />
