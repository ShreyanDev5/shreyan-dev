...
const socialLinks = [
  {
    ...
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 h-4 text-white group-hover/btn:text-black transition-colors duration-200" fill="currentColor">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-2 sm:gap-2.5 flex-wrap w-full">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="group/btn p-2 rounded-lg border border-white/10 bg-white/[0.025] text-white hover:bg-white hover:text-black hover:border-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-400/40"
