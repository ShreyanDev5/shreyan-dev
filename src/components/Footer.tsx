...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-gradient-to-b from-background/30 to-background/50 backdrop-blur-sm border-t border-white/5 py-12 px-4">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="w-16 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent mb-2" />
