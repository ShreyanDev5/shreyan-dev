...
const socialLinks = [
  {
    ...
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 h-4 text-white group-hover:text-black transition-colors duration-200" fill="currentColor">
...
const AboutSection: FC = () => {
  ...
  return (
    <div className="about-section w-full pt-14 sm:pt-16 pb-8 sm:pb-12" id="about">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <motion.div
            ...
            className="lg:col-span-4 flex flex-col items-center justify-center lg:items-start lg:self-start lg:pt-1 lg:-ml-4"
          >
            <div className="w-full max-w-[8.5rem] sm:max-w-[9.5rem] lg:max-w-[10.5rem] aspect-[3/4] rounded-[1.5rem] p-[1px] bg-gradient-to-br from-white/[0.10] via-white/[0.05] to-white/[0.02] shadow-[0_12px_30px_rgba(0,0,0,0.34)]">
              <div className="h-full w-full overflow-hidden rounded-[1.45rem] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.04),rgba(255,255,255,0.015)_45%,rgba(255,255,255,0.008)_100%)] ring-1 ring-inset ring-white/[0.03] backdrop-blur-sm">
                <img
                  src={PROFILE_IMAGE}
                  alt="Shreyan Sardar"
          ...
          >
            ...
            <div className="text-gray-300 text-sm sm:text-base leading-[1.45] mb-5 text-center lg:text-left space-y-2.5 font-light">
              <p>
                Computer Science graduate (8.3 CGPA) focused on Java (Spring Boot) and Python (FastAPI) backend engineering—experienced in API design and database operations (PostgreSQL, MySQL).
              </p>
              <p className="text-gray-400 text-xs sm:text-sm leading-[1.45]">
            ...
            <div className="mt-1 flex items-center justify-center lg:justify-start gap-2.5 sm:gap-3 flex-wrap w-full">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="group p-1.5 sm:p-2 rounded-md sm:rounded-lg border border-white/15 bg-transparent text-white hover:bg-white hover:text-black hover:border-white transition-all duration-200"
